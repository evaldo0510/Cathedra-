  ...
  return (
    <div className="max-w-7xl mx-auto space-y-12 pb-48 animate-in fade-in duration-700">
      <header className="text-center space-y-6 pt-10">
        ...
        <p className="text-stone-400 italic text-2xl font-serif mt-2">O Cânon Católico Completo (73 Livros)</p>
        ...
        {viewMode === 'library' && (
          <div className="max-w-2xl mx-auto relative mt-8 px-4">
             ...
             <input 
               ...
               className="w-full pl-16 pr-8 py-6 bg-white dark:bg-stone-900 border border-stone-100 dark:border-stone-800 rounded-[2rem] shadow-xl outline-none text-xl font-serif italic focus:border-gold transition-all dark:text-white"
             />
          </div>
        )}
      </header>
      ...
      {viewMode === 'reading' && selectedBook && (
        <article className="max-w-4xl mx-auto px-6 space-y-12 animate-in slide-in-from-bottom-10">
           <header className="flex flex-col md:flex-row md:items-center justify-between gap-6 border-b border-stone-100 dark:border-stone-800 pb-10">
              <div>
